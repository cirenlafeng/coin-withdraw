                                ...
                                <form class="form-horizontal" action="/user" method="post">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label" for="focusedInput">昵称</label>
                                            <div class="col-lg-4">
                                                <input class="form-control" id="focusedInput" type="text" name="name" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label" for="focusedInput">邮箱</label>
                                            <div class="col-lg-4">
                                                <input class="form-control" id="focusedInput" type="text" name="email" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label" for="focusedInput">密码</label>
                                            <div class="col-lg-4">
                                                <input class="form-control" id="focusedInput" type="password" name="password" value="" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label" for="focusedInput">确认密码</label>
                                            <div class="col-lg-4">
                                                <input class="form-control" id="focusedInput" type="password" name="password_re" value="" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
